...
export class ReclamationProvider {
  ...
  getReclamationList(token:string){
    let url = "http://192.168.1.88:8000/api/reclamation/?token=" + token;
    console.log(url);
  ...
  getReclamationInfo(id: string, token: String){
    let url = "http://192.168.1.88:8000/api/reclamation/"+id+"?token=" + token;
    console.log(url);
    return this.http.get(url, { headers: this._headers })
  ...
  sendReclamation(reclamation){
    ...
    let url = "http://192.168.1.88:8000/api/reclamation/new";
  ...
  public Delete_Reclamation(id,token) {
    let url = "http://192.168.1.88:8000/api/reclamation/"+id;
